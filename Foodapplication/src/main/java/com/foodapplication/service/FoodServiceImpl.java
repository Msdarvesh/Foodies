...
import com.foodapplication.entity.FoodEntity;
import com.foodapplication.io.FoodRequest;
import com.foodapplication.io.FoodResponse;
import com.foodapplication.repository.FoodRepository;
...
//               return "https://"+bucketName+"s3.amazonaws.com/"+key;
    ...
    private FoodEntity convertToEntity(FoodRequest request){
       return FoodEntity.builder().name(request.getName())
    ...
    private FoodResponse convertToResponse(FoodEntity entity){
       return FoodResponse.builder().id(entity.getId())
                .name(entity.getName())
